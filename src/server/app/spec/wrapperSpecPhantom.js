    ...
    describe('Test FileSystem Service:', function () {
       ...
       async.it('list', function(done) {
        ...
        async.it('writeFile', function(done) {
            ...
            webidafs.writeFile(testDirName+'/testfile3.test', 'utf8', 'This is a file with utf8 encoding.', function(err) {
                expect(err).toBeNull();
                
                //data : This is a file with utf8 encoding.
                webidafs.writeFile(testDirName+'/testfile4.test', 'base64', 'VGhpcyBpcyBhIGZpbGUgd2l0aCBiYXNlNjQgZW5jb2Rpbmcu', function(err) {
                    expect(err).toBeNull();
